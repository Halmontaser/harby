...
import {ref} from 'vue'
const doctype ="tender"

const doc=ref({data:{name:'tn-2023-776',attachments:[]}})
</script>

    <!-- <template >
    <div class="flex space-x-3">
    <div>
        <div class="w-full p-1 text-green-700 border border-green-300 rounded-md bg-green-50 dark:bg-gray-800 dark:border-green-800 dark:text-green-400" >
            <div class="flex space-x-2 items-center justify-between">
                <span class="sr-only">User info</span>
                <h3 class="font-medium">1. User info</h3>
                <svg class="w-5 h-5 rounded-full bg-blue-500 text-white p-1 text-bold" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
    ...
    <div>
        <div class="w-full p-1 text-green-700 border border-green-300 rounded-sm bg-green-50 dark:bg-gray-800 dark:border-green-800 dark:text-green-400">
    ...
    <div>
        <div class="w-full p-1 text-blue-700 bg-blue-100 border border-blue-300 rounded-lg dark:bg-gray-800 dark:border-blue-800 dark:text-blue-400" role="alert">
            <div class="flex items-center space-x-2 justify-between">
